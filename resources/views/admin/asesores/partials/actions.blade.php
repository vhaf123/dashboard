<div class="d-flex flex-nowrap justify-content-end">
    ...
    <a href="{{route('admin.asesores.show', $id)}}" class="btn btn-info btn-sm" role="button">
        <i class="fas fa-eye"></i>
    </a>

    <a href="{{route('admin.asesores.edit', $id)}}" class="btn btn-success btn-sm mx-1" role="button">
        <i class="fas fa-edit"></i>
    </a>

    @php
        $ruta = route('admin.asesores.destroy', $id);
    @endphp
